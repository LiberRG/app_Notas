 ...
 */
final class Version20240123190124 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD rol_id INT DEFAULT NULL, DROP rol');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD rol INT NOT NULL, DROP rol_id');
    }
}
